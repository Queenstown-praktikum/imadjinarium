      ...
      <article className={styles.rules__content}>
        ...
        <div className={styles.rules__right}>
          <section className={styles['rules-info__item']}>
            ...
            <p className={styles['rules-info']}>
              Если ассоциацию ведущего угадал один или несколько игроков, то он получает +3 очка плюс по одной за
              каждого участника.
            </p>
            <p className={styles['rules-info']}>
              ...
              получает 3 очка, ведущий получает 3 очка и по одному очку за каждого играка угадавщего его карту. Все
              игроки получают по одному очку за кажлого игрока, которвй угадал их карту.
            </p>
          </section>
        </div>
      </article>
